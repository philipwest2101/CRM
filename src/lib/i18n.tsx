...
export const TRANSLATIONS = {
  ...
  de: {
    ...
    tooltip_kpiTotalAppointments: "Alle geplanten Termine, vergangen und bevorstehend.",
    tooltip_kpiCallAttempts: "Kontakte, die die maximale Anzahl an Anrufversuchen erreicht haben, ohne erreicht zu werden.",
    tooltip_kpiClosings: "Kontakte, die im aktuellen Zeitraum erfolgreich abgeschlossen wurden.",
